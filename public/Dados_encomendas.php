...
$consulta_clientes = "SELECT nome_cliente as 'Cliente', endereco_cliente, numero_cliente, telefone_cliente, qtde_vendida as 'Quantidade Adquirida', nome_produto, preco_unitario as 'Valor Total da Compra', sum(preco_unitario * qtde_vendida) as Sub, hora_venda ";
...
$consulta_clientes .= "ORDER BY hora_venda DESC ";
...
<nav class="navbar navbar-inverse" style="background-color: #392929">
    ...
    <table class="table table-hover" style="margin-top: 20px">
       ...
       ?>
        ...
        <td style="text-align: center"> R$ <?php echo $registro ["Sub"]?></td>    
