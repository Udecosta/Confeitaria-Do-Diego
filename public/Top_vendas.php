...
$consulta_clientes = "SELECT nome_cliente as 'Cliente', sum(qtde_vendida) as 'Quantidade Adquirida', sum(preco_unitario * qtde_vendida) as 'Valor', hora_venda ";
...
$consulta_clientes .= "GROUP BY nome_cliente ";
$consulta_clientes .= "ORDER BY Valor DESC";
...
<nav class="navbar navbar-inverse" style="background-color: #392929">
    ...
    <table class="table table-hover" style="margin-top: 20px">
        ...
        <th scope="col" style="text-align: center">Quantidade de Itens</th>
        ...
        <td style="text-align: center">R$ <?php echo $registro ["Valor"]?></td> 
