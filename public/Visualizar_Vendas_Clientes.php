...
$consulta_clientes = "SELECT nome_cliente as 'Cliente', qtde_vendida as 'Quantidade Adquirida', nome_produto, preco_unitario as 'Valor Total da Compra', sum(preco_unitario * qtde_vendida) as Sub, hora_venda ";
