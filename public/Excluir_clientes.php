...
if (isset ($_POST["nome_cliente"])){
    ...
    $exclusao = "DELETE FROM tb_clientes ";
    $exclusao .= "WHERE id_cliente = {$excID}";
...
$tr = "SELECT * FROM tb_clientes ";

if(isset($_GET["codigo"])){
    $id = $_GET["codigo"];
    $tr .= "WHERE id_cliente = {$id} ";
...
$info_clientes = mysqli_fetch_assoc($con_cliente);
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="Excluir_clientes.php" method="post">
                            
            <label for="nome">Nome do Cliente:</label>
            <input type="text" class="form-control" value="<?php echo utf8_encode ($info_clientes["nome_cliente"]) ?>" name="nome_cliente" id="nome">
            
            <label for="endereco">Endereço do Cliente:</label>
            <input type="text" class="form-control" value="<?php echo utf8_encode ($info_clientes["endereco_cliente"]) ?>" name="endereco_cliente" id="endereco">
            
            <label for="telefone">Telefone do Cliente:</label>
            <input type="text" class="form-control" value="<?php echo utf8_encode ($info_clientes["telefone_cliente"]) ?>" name="telefone_cliente" id="telefone">
                
            <label for="email">Email do Cliente:</label>
            <input type="text" class="form-control" value="<?php echo utf8_encode ($info_clientes["email_cliente"]) ?>" name="email_cliente" id="email">    
