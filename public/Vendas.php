...
$consulta_clientes = "SELECT b.nome_produto as 'Nome do Produto', sum(qtde_vendida) as 'Quantidade Vendida', b.preco_unitario as 'Preço Unitario', sum(qtde_vendida) * preco_unitario as 'Venda Total', count(a.qtde_vendida) as 'Qtde Por Produto'";
...
$consulta_clientes .= "GROUP BY nome_produto ";
...
<nav class="navbar navbar-inverse" style="background-color: #392929">
    ...
    <table class="table table-hover" style="margin-top: 20px">
        ...
        <td style="text-align: center"> R$ <?php echo $registro ["Preço Unitario"]?></td>
